 ...
 * medical
 * @author : fater
 * @created :  1:17 PM,3/19/2021,2021
 **/
?>
            ...
            <ul class="blog clearfix">
                <li class="post">
                    ...
                    <div class="post_content">
                        <a class="post_image" href="indexb878.html?page=post"
                           title="Lorem ipsum dolor sit amat velum">
                            <img src="public/images/samples/520x240/image_03.jpg" alt=""/>
                        </a>
                        <h2>
                        ...
                        <p>
                            ...
                            Suspendisse pulvinar, velit nec pharetra interdum, ante tellus ornare mi, et mollis
                            tellus neque vitae elit.
                            Mauris adipiscing mauris fringilla turpis interdum sed pulvinar nisi malesuada. Lorem
                            ipsum dolor sit amet, consectetur adipiscing elit.
                        </p>
                        <p>
                            Donec sed odio dui. Nulla vitae elit libero, a pharetra augue. Nullam id dolor id nibh
                            ultricies vehicula ut id elit. Integer posuere erat a ante venenatis dapibus posuere
                            velit aliquet. Duis mollis, est non commodo luctus, nisi erat porttitor ligula. Mauris
                            sit amet neque nec nunc gravida.
                        </p>
                ...
                <li class="post">
                    ...
                    <div class="post_content">
                        <a class="post_image" href="indexb878.html?page=post"
                           title="Lorem ipsum dolor sit amat velum">
                            <img src="public/images/samples/520x240/image_08.jpg" alt=""/>
                        </a>
                        <h2>
                            <a href="indexb878.html?page=post" title="Lorem ipsum dolor sit amat velum">
                                Lorem ipsum dolor sit amat velum
                ...
                <li class="post">
                    ...
                    <div class="post_content">
                        ...
                        <blockquote>
                            ...
                            sollicitudin interdum.
                            Suspendisse pulvinar, velit nec pharetra interdum, ante tellus ornare mi, et mollis
                            tellus neque vitae elit volutpat rutrum eros.
                        </blockquote>
                        <a title="Read more" href="indexb878.html?page=post" class="more">
                            Read more &rarr;
                        </a>
                ...
                <li class="post">
                    ...
                    <div class="post_content">
                        <h2>
                            <a target="_blank"
                               href="http://themeforest.net/item/CHSM-responsive-medical-health-template/4000598?ref=QuanticaLabs"
                               title="Lorem ipsum dolor sit amat velum">
                                Lorem ipsum dolor sit amat velum
                            </a>
                        </h2>
                        ...
                        <a title="Visit link" target="_blank"
                           href="http://themeforest.net/item/CHSM-responsive-medical-health-template/4000598?ref=QuanticaLabs"
        ...
        <div class="page_right">
            ...
            <div class="sidebar_box">
                <div class="clearfix">
                    ...
                    <div class="header_right">
                        <a href="#" id="most_commented_prev"
                           class="scrolling_list_control_left icon_small_arrow left_black"></a>
                        <a href="#" id="most_commented_next"
                           class="scrolling_list_control_right icon_small_arrow right_black"></a>
                    </div>
                </div>
            ...
            <div class="sidebar_box">
                <div class="clearfix">
                    ...
                    <div class="header_right">
                        <a href="#" id="most_viewed_prev"
                           class="scrolling_list_control_left icon_small_arrow left_black"></a>
                        <a href="#" id="most_viewed_next"
                           class="scrolling_list_control_right icon_small_arrow right_black"></a>
                    </div>
                </div>
                <div class="scrolling_list_wrapper">
            ...
            <div class="sidebar_box">
                ...
                <ul class="photostream clearfix">
                    <li class="gallery_box">
                        <img src="public/images/samples/75x75/image_01.jpg" alt=""/>
                        <ul class="controls">
                            <li>
                                <a href="public/images/samples/image_01.jpg" rel="photostream"
                                   class="fancybox open_lightbox"></a>
                            </li>
                        </ul>
                    </li>
                    <li class="gallery_box">
                        <img src="public/images/samples/75x75/image_02.jpg" alt=""/>
                        <ul class="controls">
                            <li>
                                <a href="public/images/samples/image_02.jpg" rel="photostream"
                                   class="fancybox open_lightbox"></a>
                            </li>
                        </ul>
                    </li>
                    <li class="gallery_box">
                        <img src="public/images/samples/75x75/image_03.jpg" alt=""/>
                        <ul class="controls">
                            <li>
                                <a href="public/images/samples/image_03.jpg" rel="photostream"
                                   class="fancybox open_lightbox"></a>
                            </li>
                        </ul>
                    </li>
                    <li class="gallery_box">
                        <img src="public/images/samples/75x75/image_04.jpg" alt=""/>
                        <ul class="controls">
                            <li>
                                <a href="public/images/samples/image_04.jpg" rel="photostream"
                                   class="fancybox open_lightbox"></a>
                            </li>
                        </ul>
                    </li>
                    <li class="gallery_box">
                        <img src="public/images/samples/75x75/image_05.jpg" alt=""/>
                        <ul class="controls">
                            <li>
                                <a href="public/images/samples/image_05.jpg" rel="photostream"
                                   class="fancybox open_lightbox"></a>
                            </li>
                        </ul>
                    </li>
                    <li class="gallery_box">
                        <img src="public/images/samples/75x75/image_06.jpg" alt=""/>
                        <ul class="controls">
                            <li>
                                <a href="public/images/samples/image_06.jpg" rel="photostream"
                                   class="fancybox open_lightbox"></a>
                            </li>
                        </ul>
                    </li>
                    <li class="gallery_box">
                        <img src="public/images/samples/75x75/image_07.jpg" alt=""/>
                        <ul class="controls">
                            <li>
                                <a href="public/images/samples/image_07.jpg" rel="photostream"
                                   class="fancybox open_lightbox"></a>
                            </li>
                        </ul>
                    </li>
                    <li class="gallery_box">
                        <img src="public/images/samples/75x75/image_08.jpg" alt=""/>
                        <ul class="controls">
                            <li>
                                <a href="public/images/samples/image_08.jpg" rel="photostream"
                                   class="fancybox open_lightbox"></a>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="sidebar_box">
                ...
                <p class="info">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut volutpat rutrum eros sit amet
                    sollicitudin.
                </p>
                <ul class="contact_data">
                    ...
                    <li class="clearfix">
                        ...
                        <p class="value">
                            by e-mail: <a href="mailto:CHSM@mail.com">CHSM@mail.com</a>
                        </p>
                    </li>
                    <li class="clearfix">
                        <span class="social_icon form"></span>
                        <p class="value">
                            or <a href="index53a6.html?page=contact" title="Contact form">fill in the form</a> on
                            our contact page
                        </p>
                    </li>
                </ul>
